 ...
 */
    class CommandLineClient
    {
        ...
        public CommandLineClient(WC wc)
        {
            myWC = wc;
        }
        ...
        /* static void Main(String[] args) {    
             ...
             TP.WC wc = (TP.WC)System.Activator.GetObject(typeof(RM), "http://" + rmiHost + ":" + rmiPort + "/WC.soap"); 
             CommandLineClient client = new CommandLineClient(wc);
